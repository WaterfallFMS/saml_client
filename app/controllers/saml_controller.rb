...
private
  ...
  def setup
    ...
    # a copy of what is in the OmniAuth Saml provider
    @settings = Onelogin::Saml::Settings.new
    @settings.assertion_consumer_service_url = saml_action_url(:action => 'consume')
    @settings.issuer                 = ENV['SAML_IDP_ISSUER']
    @settings.idp_sso_target_url     = ENV['SAML_IDP_TARGET_URL']
    @settings.idp_cert_fingerprint   = ENV['SAML_IDP_CERT_FINGERPRINT']
    @settings.name_identifier_format = ENV['SAML_IDP_NAME_FORMAT']
  end
